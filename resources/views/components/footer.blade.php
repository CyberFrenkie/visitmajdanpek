<footer class="my-5">
    ...
    <div class="container">
        <div class="row">
            ...
            <a href=" {{ trans('footer.far-left-link') }} "> 
                <p class="{{ trans('footer.upper-text-class') }}"> {{ trans('footer.upper-text') }} </p>
                <p class="{{ trans('footer.bottom-text-class') }}"> {{ trans('footer.bottom-text') }} </p>
            </a> 
                <p class="{{ trans('footer.copyright-class') }}"> {{ trans('footer.copyright') }}</p>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                ...
                @foreach (trans('footer.left-list') as $list)    
                        ...
                        <li>
                            <a href="{{ $listValue['url'] }}" class="{{ $listValue['class'] }}">{{ $listValue['text'] }}</a>
                        </li>
                        @endforeach
                @endforeach    
                </ul>
