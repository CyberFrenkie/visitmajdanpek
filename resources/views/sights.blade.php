      ...
      <div class="container-fluid split-hero">
        <div class="split-card one">
          <a href="/sights/mpek" class="card-link link text-light">
            ...
            <p class="par">{{ __('sights.sights.par1') }}<span class="d-block mt-2"><a href="{{ __('sights.sights.url1') }}" class="cta">{{ __('sights.sights.btn.text') }}<i class="{{ __('custom-footer.arrow-icon') }} arrow-right ms-2"></i></a></span></p>
          </a>
        </div>
        <div class="split-card two">
          <a href="/sights/dm-sights" class="card-link link text-light">
            ...
            <p class="par">{{ __('sights.sights.par2') }}<span class="d-block mt-2"><a href="{{ __('sights.sights.url2') }}" class="cta">{{ __('sights.sights.btn.text') }}<i class="{{ __('custom-footer.arrow-icon') }} arrow-right ms-2"></i></a></span></p>
          </a>
        </div>
      </div>
    </div>
